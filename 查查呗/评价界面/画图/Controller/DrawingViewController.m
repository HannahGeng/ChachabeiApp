...
//    NSLog(@"分享");
    ...
    [UMSocialSnsService presentSnsIconSheetView:self appKey:@"567b956ae0f55a9148002011" shareText:@"查查呗是信用查询的最佳平台" shareImage:[UIImage imageNamed:@"icon.png"] shareToSnsNames:[NSArray arrayWithObjects:UMShareToSina,UMShareToTencent,UMShareToRenren,UMShareToEmail,nil] delegate:nil];
