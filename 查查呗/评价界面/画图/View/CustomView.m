...
- (id)initWithFrame:(CGRect)frame valueDictionary:(NSDictionary *)valueDictionary
{
    ...
    if (self) {
        ...
        _maxValue = 0;
        _valueDivider = 1;
        _drawboardColor = [UIColor lightGrayColor];
        _plotColor = [UIColor colorWithRed:34.0/255.0 green:145.0/255.0 blue:255.0/255.0 alpha:.7];
...
//    CGFloat boundHeight =  self.bounds.size.height-120;
    ...
    CGFloat boundHeight =  [UIScreen mainScreen].bounds.size.height - 128;
