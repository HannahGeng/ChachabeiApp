...
- (id)initWithRootViewController:(UIViewController *)rootViewController
{
    self = [super init];
    if (self) {
        _middleViewController=rootViewController ;
    }
    return self;
}
...
- (void)resetNavButtons
{
    ...
    if (menuFlags.canShowLeft) {
        UIImage *buttonImageNormal = [UIImage imageNamed:@"app03.png"];
        UIButton *leftButton = [[UIButton alloc] initWithFrame:CGRectMake(-20.0f, 0.0f, 25, 20)];
